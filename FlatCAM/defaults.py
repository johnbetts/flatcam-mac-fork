...
class FlatCAMDefaults:
	...
	factory_defaults = {
		...
		"global_gray_icons": is_theme_black(),
		...
		"global_proj_item_color": '',  # use system palette
		"global_proj_item_dis_color": '',  # use system palette
		...
		"geometry_plot_line": "#FFAAAA" if is_theme_black else "#FF0000",
